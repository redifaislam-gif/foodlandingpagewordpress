...
class Init {
    ...
    public function show($banner) {
        ...
        if($banner->start <= time() && time() <= $banner->end) {
            ...
            if($this->is_correct_screen_to_show($banner->screen, $screen->id) && class_exists('\Oxaim\Libs\New_Notice')) {
                ...
                \Oxaim\Libs\New_Notice::instance('wpmet-jhanda', $banner_unique_id)
